                    ...
                    <div className="flex flex-col items-center justify-center md:w-[70%] w-full mx-auto pt-12 gap-12 h-full bg-white z-10 relative">
                        ...
                        >
                            ...
                            <div className={`${inputContainerClass} relative`}>
                                ...
                                <textarea
                                    placeholder="Company infomation for training AI Support Agent"
                                    required
                                    name="document"
                                    minLength={50}
                                    rows={4}
                        ...
                        <div className="flex flex-col items-center gap-10 w-full overflow-y-scroll flex-1 z-10">
                            <div>
                                <h1 className="text-xl text-dark-blue-color text-center">
                                    Quickly respond to customer's needs in your
                                    absence
                                </h1>
                                <p className="text-sm mt-2">
                                    Provide customers the swift response they
                                    seek to improve their business
                                </p>
                            </div>
                            <p className="text-sm">
                                Paste this code just in the {"</head>"} tag of
                                your site code
                            </p>
                            <div className={`${inputContainerClass}`}>
