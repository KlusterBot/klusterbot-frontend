        ...
        <div className="text-lighter-color">
                    ...
                    <div className="flex flex-col gap-8 w-[55%] max-md:w-full">
                        ...
                        <div className="flex gap-8 justify-between flex-wrap">
                            <div>
                                ...
                                <p>
                                    Respond to customer messages using
                                    conversational AI that emulates human
                                    language. Kluster can address customer's
                            ...
                            <div>
                                ...
                                <p>
                                    Put personalized support within reach so
                                    customers can get fast answers on their
            ...
            <Container className="bg-primary-light-blue">
                <h1 className="sm:text-3xl text-xl text-center font-bold md:py-32 md:w-[60%] py-8">
                    We collaborate with all enterprises (SMEs, MNEs) to
                    facilitate growth in Kluster
                </h1>
            </Container>
                ...
                >
                    <div className="w-[45%] max-md:w-full">
                        <h2 className={clsx(`${h2Classes} mb-8`)}>
                            Interact with visitors on your website through live
                            chat
                        </h2>
                        <h4 className={clsx(`${h4Classes}`)}>
                        ...
                        <p>
                            Utilize the live chat to actively engage with your
                            visitors, providing personalized information
                            tailored to their activities to cultivate loyalty
            ...
            <Container className="">
                <div className="flex flex-col gap-8  py-8 md:pb-32 items-center justify-between">
                    ...
                    <p className="p-4 text-center">
                        Our chatbot can reduce the workload on your team by
                    ...
                    <div className="flex items-center justify-between gap-8 mb-8">
                        <img
                            src={faqChat}
                            alt=""
                            className="w-[45%] sm:block hidden"
                        />
                        <div>
                            <h4 className={clsx(`${h4Classes}`)}>
                            ...
                            <p>
                                Most frequently asked questions by visitors are
                                well attended to by our chatbots, so you can
                                focus on more productive task.
                            </p>
                            <Link to="/signup">
                                <Button
                    ...
                    <div className="flex items-center flex-row-reverse justify-between gap-8 mb-6">
                        ...
                        <div className="">
                            ...
                            <p>
                                Unlock premium functionalities. Streamline your
                                customer service with Kluster AI. Collaborate
                                with our effective AI to automate your business.
                            </p>
                            <Link to="/signup">
                                <Button
                                    buttonText="Get Started"
